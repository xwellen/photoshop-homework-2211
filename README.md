...
Теперь, когда вы выполнили работу, нужно сохранить ее и отправить в формате photoshop (PSD). Посмотрите как это сделать ниже:

### Шаг 1.

Чтобы сохранить документ, в меню окна нажмите File -> Save, откроется диалоговое окно

![save-1](pic/save-1.jpg)

### Шаг 2.

В окне можно выбрать путь по которому программа сохранит файл, имя и формат. Задайте имя файлу, расширение оставьте PSD.

![save-2](pic/save-2.jpg)

### Шаг 3.

Далее фотошоп предложит вам максимизировать совместимость, это нужно чтобы файл открывался в других версиях фотошопа. Так как мы используем базовые возможности программы, то тут можно просто нажать ОК и не обращать внимания. От этого ничего не измменится.

![save-3](pic/save-3.jpg)
